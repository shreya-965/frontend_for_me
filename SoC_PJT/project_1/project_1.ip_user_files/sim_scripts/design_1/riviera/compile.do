...
vlog -work xpm  -incr "+incdir+../../../../../../../../../run/media/shreya/Ultra Touch/Vivado/ubuntu_vivado/2025.2/data/rsb/busdef" "+incdir+../../../../project_1.gen/sources_1/bd/design_1/ipshared/a415" "+incdir+../../../../project_1.gen/sources_1/bd/design_1/ipshared/ec67/hdl" -l xpm -l blk_mem_gen_v8_4_12 -l xil_defaultlib -l util_vector_logic_v2_0_5 \
...
vlog -work blk_mem_gen_v8_4_12  -incr -v2k5 "+incdir+../../../../../../../../../run/media/shreya/Ultra Touch/Vivado/ubuntu_vivado/2025.2/data/rsb/busdef" "+incdir+../../../../project_1.gen/sources_1/bd/design_1/ipshared/a415" "+incdir+../../../../project_1.gen/sources_1/bd/design_1/ipshared/ec67/hdl" -l xpm -l blk_mem_gen_v8_4_12 -l xil_defaultlib -l util_vector_logic_v2_0_5 \
"../../../../project_1.gen/sources_1/bd/design_1/ip/design_1_picorv32_core_0_0/src/simulation/blk_mem_gen_v8_4.v" \

vlog -work xil_defaultlib  -incr -v2k5 "+incdir+../../../../../../../../../run/media/shreya/Ultra Touch/Vivado/ubuntu_vivado/2025.2/data/rsb/busdef" "+incdir+../../../../project_1.gen/sources_1/bd/design_1/ipshared/a415" "+incdir+../../../../project_1.gen/sources_1/bd/design_1/ipshared/ec67/hdl" -l xpm -l blk_mem_gen_v8_4_12 -l xil_defaultlib -l util_vector_logic_v2_0_5 \
...
vlog -work util_vector_logic_v2_0_5  -incr -v2k5 "+incdir+../../../../../../../../../run/media/shreya/Ultra Touch/Vivado/ubuntu_vivado/2025.2/data/rsb/busdef" "+incdir+../../../../project_1.gen/sources_1/bd/design_1/ipshared/a415" "+incdir+../../../../project_1.gen/sources_1/bd/design_1/ipshared/ec67/hdl" -l xpm -l blk_mem_gen_v8_4_12 -l xil_defaultlib -l util_vector_logic_v2_0_5 \
